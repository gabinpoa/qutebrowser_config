...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/gab/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/gab/.local/share/qutebrowser/userscripts/*')
...
# Bindings
config.bind('<Ctrl-p>', 'search')
config.bind(',y', 'hint links spawn --detach mpv -ao=pulse {hint-url}')
